...
const DefaultHandle = () => <div className="mx-auto mt-4 h-2 w-[100px] rounded-full bg-neutral-100 " />;

const DrawerContent = React.forwardRef<
  React.ElementRef<typeof DrawerPrimitive.Content>,
  React.ComponentPropsWithoutRef<typeof DrawerPrimitive.Content> & { handle?: React.ReactNode }
>(({ handle = <DefaultHandle />, className, children, ...props }, ref) => (
  <DrawerPortal>
    <DrawerOverlay />
...
DrawerBody.displayName = DrawerPrimitive.Description.displayName;
